    ...
    <section className="py-32 md:py-40 px-6 md:px-10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <motion.div
          ...
          className="space-y-8"
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white dark:text-white light:text-gray-900 light:pink-outline-strong light:bg-black/20 light:px-6 light:py-3 light:rounded-xl">
