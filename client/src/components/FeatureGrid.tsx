  ...
  return (
    <section className="py-32 md:py-40 px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.h2 variants={fadeInUp} className="text-4xl md:text-5xl font-bold text-white dark:text-white light:text-gray-900 light:pink-outline mb-6">
            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-white dark:text-white light:text-gray-900 light:pink-outline mb-4 group-hover:text-pink-400 transition-colors duration-300">
                    {feature.title}
                  </h3>
