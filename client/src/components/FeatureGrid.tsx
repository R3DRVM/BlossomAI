  ...
  return (
    <section className="py-32 md:py-40 px-6 md:px-10">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.h2 variants={fadeInUp} className="text-4xl md:text-5xl font-bold text-white dark:text-white light:text-white pink-outline-strong light:bg-black/20 light:px-6 light:py-3 light:rounded-xl mb-6">
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-pink-500/20 to-purple-600/20 rounded-2xl flex items-center justify-center text-pink-400 mb-6 group-hover:scale-110 group-hover:from-pink-500/30 group-hover:to-purple-600/30 transition-all duration-300">
                   ...
                   <h3 className="text-xl font-bold text-white dark:text-white light:text-white pink-outline mb-4 group-hover:text-pink-400 transition-colors duration-300">
                     {feature.title}
                   </h3>
