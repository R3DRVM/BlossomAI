    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 text-center">
        ...
        >
          ...
          >
            <span className="text-white dark:text-white light:text-gray-900 light:pink-outline-strong light:bg-black/20 light:px-6 light:py-3 light:rounded-xl">Deploy millions, intelligently.</span>
          </motion.h1>
