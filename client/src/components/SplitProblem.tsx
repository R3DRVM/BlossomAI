              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300 dark:text-gray-300 light:text-gray-700 text-lg leading-relaxed">
                    <strong className="gradient-text">Fragmented DeFi:</strong> Scattered protocols, manual research, and compliance drag.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-stack p-8">
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300 dark:text-gray-300 light:text-gray-700 text-lg leading-relaxed">
                    <strong className="gradient-text">Blossom Unified AI:</strong> One aggregator to discover, execute, and manage with institutional control.
                  </p>
                </div>
              </div>
            </div>
