...
export function FloatingChat() {
  ...
  return (
    ...
    >
      <div 
        onClick={handleClick}
        className="bg-gradient-to-r from-pink-500 to-purple-600 text-white p-5 rounded-2xl shadow-glow cursor-pointer group backdrop-blur-sm hover:scale-105 transition-transform duration-300"
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs opacity-90">how to maximize yield on $10M in USDC</p>
          </div>
        </div>
